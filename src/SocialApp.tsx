...
const SocialApp = () => {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      {currentView === "profile" && <ProfileScreen posts={posts} />}
      ...
      <View style={styles.navbar}>
        <Pressable onPress={() => setCurrentView("home")} style={styles.navItem}>
          <Home
            color={currentView === "home" ? "#8B5CF6" : "#6B7280"}
            size={28}
          />
        </Pressable>
        ...
        <Pressable onPress={() => setCurrentView("explore")} style={styles.navItem}>
          <Compass
            color={currentView === "explore" ? "#8B5CF6" : "#6B7280"}
            size={28}
          />
        </Pressable>
        ...
        <Pressable onPress={() => setCurrentView("friends")} style={styles.navItem}>
          <Users
            color={currentView === "friends" ? "#8B5CF6" : "#6B7280"}
            size={28}
          />
        </Pressable>
        ...
        <Pressable onPress={() => setCurrentView("profile")} style={styles.navItem}>
          <User
            color={currentView === "profile" ? "#8B5CF6" : "#6B7280"}
            size={28}
          />
        </Pressable>
      </View>
